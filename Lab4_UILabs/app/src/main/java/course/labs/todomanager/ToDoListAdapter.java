...
public class ToDoListAdapter extends BaseAdapter {
	...
	@Override
	public View getView(int position, View convertView, ViewGroup parent) {//not fully implemented view holder
		...
		LayoutInflater inflater = (LayoutInflater) mContext.getSystemService( Context.LAYOUT_INFLATER_SERVICE );// need to use this outside of
		...
		Log.i(TAG, "logi after set up status view ");
